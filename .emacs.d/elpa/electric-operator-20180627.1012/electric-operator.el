...
(apply #'add-rules-for-mode 'js-jsx-mode prog-mode-rules)
(add-rules-for-mode 'js-jsx-mode
                    (cons "%=" " %= ")
                    (cons "++" "++ ")
                    (cons "--" "-- ")
                    (cons "===" " === ")
...
(apply #'add-rules-for-mode 'js2-mode (get-rules-for-mode 'js-jsx-mode))

(apply #'add-rules-for-mode 'typescript-mode (get-rules-for-mode 'js-jsx-mode))
